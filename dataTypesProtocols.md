...
|**requiredProtocols**    |Where relevant, methods used to determine environmental condition set points (air temperature, relative humidity, VPD, irradiance, CO~2~ concentration). Measurement methods, including use of ambient or altered conditions, and how long leaf was in chamber prior to data collection. Indicate if reported values are single measurements or averaged values. |
